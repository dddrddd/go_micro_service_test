...
const (
	Goods_GoodsList_FullMethodName            = "/template.Goods/GoodsList"
	Goods_BatchGetGoods_FullMethodName        = "/template.Goods/BatchGetGoods"
	Goods_CreateGoods_FullMethodName          = "/template.Goods/CreateGoods"
	Goods_DeleteGoods_FullMethodName          = "/template.Goods/DeleteGoods"
	Goods_UpdateGoods_FullMethodName          = "/template.Goods/UpdateGoods"
	Goods_GetGoodsDetail_FullMethodName       = "/template.Goods/GetGoodsDetail"
	Goods_GetAllCategorysList_FullMethodName  = "/template.Goods/GetAllCategorysList"
	Goods_GetSubCategory_FullMethodName       = "/template.Goods/GetSubCategory"
	Goods_CreateCategory_FullMethodName       = "/template.Goods/CreateCategory"
	Goods_DeleteCategory_FullMethodName       = "/template.Goods/DeleteCategory"
	Goods_UpdateCategory_FullMethodName       = "/template.Goods/UpdateCategory"
	Goods_BrandList_FullMethodName            = "/template.Goods/BrandList"
	Goods_CreateBrand_FullMethodName          = "/template.Goods/CreateBrand"
	Goods_DeleteBrand_FullMethodName          = "/template.Goods/DeleteBrand"
	Goods_UpdateBrand_FullMethodName          = "/template.Goods/UpdateBrand"
	Goods_BannerList_FullMethodName           = "/template.Goods/BannerList"
	Goods_CreateBanner_FullMethodName         = "/template.Goods/CreateBanner"
	Goods_DeleteBanner_FullMethodName         = "/template.Goods/DeleteBanner"
	Goods_UpdateBanner_FullMethodName         = "/template.Goods/UpdateBanner"
	Goods_CategoryBrandList_FullMethodName    = "/template.Goods/CategoryBrandList"
	Goods_GetCateGoryBrandList_FullMethodName = "/template.Goods/GetCateGoryBrandList"
	Goods_CreateCategoryBrand_FullMethodName  = "/template.Goods/CreateCategoryBrand"
	Goods_DeleteCategoryBrand_FullMethodName  = "/template.Goods/DeleteCategoryBrand"
	Goods_UpdateCategoryBrand_FullMethodName  = "/template.Goods/UpdateCategoryBrand"
)
