...
func InitSrvConn() {
	...
	userConn, err := grpc.Dial(
		fmt.Sprintf("consul://%s:%d/%s?wait=14s", consulInfo.Host, consulInfo.Port, global.ServerConfig.UserInfo.Name), //这一部分使用了"github.com/mbobakov/grpc-consul-resolver"，固定格式，标签可以参考官方文档
		grpc.WithInsecure(),
