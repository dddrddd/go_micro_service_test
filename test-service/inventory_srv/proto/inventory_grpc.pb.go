...
const (
	Inventory_SetInv_FullMethodName    = "/template.Inventory/SetInv"
	Inventory_InvDetail_FullMethodName = "/template.Inventory/InvDetail"
	Inventory_Sell_FullMethodName      = "/template.Inventory/Sell"
	Inventory_Reback_FullMethodName    = "/template.Inventory/Reback"
)
...
var Inventory_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "template.Inventory",
